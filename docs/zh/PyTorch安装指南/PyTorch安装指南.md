...
## CPU架构为ARM架构时，由于社区未提供ARM架构CPU版本的torch包，无法使用PIP3命令安装PyTorch1.11.0，需要使用源码编译安装。
...
版本说明请参阅[ReleseNote](https://gitee.com/ascend/pytorch/blob/v1.11.0-3.0.rc3/docs/zh/RELEASENOTE/RELEASENOTE.md)
